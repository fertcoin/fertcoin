...
In order to support loading of multiple wallets in fertcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fertcoin.cpp.
...
Changes to fertcoin.cpp
----------------------
fertcoin.cpp is the entry point into fertcoin-qt, and as such, will require some minor modifications to provide hooks for
