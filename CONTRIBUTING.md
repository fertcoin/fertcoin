Contributing to fertcoin Core
============================

The fertcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the fertcoin Core project, and is not to be
confused with overall fertcoin Network Protocol consensus changes.

Whether a pull request is merged into fertcoin Core rests with the project merge
...
Patches that change fertcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the fertcoin consensus, it must have been
...
The project leader is the release manager for each fertcoin Core release.
