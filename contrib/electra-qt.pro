...
RESOURCES += src/qt/fertcoin.qrc src/qt/fertcoin_locale.qrc

TRANSLATIONS += src/qt/locale/fertcoin_bg.ts \
                src/qt/locale/fertcoin_de.ts \
                src/qt/locale/fertcoin_en.ts \
                src/qt/locale/fertcoin_es.ts \
                src/qt/locale/fertcoin_fi.ts \
                src/qt/locale/fertcoin_fr.ts \
                src/qt/locale/fertcoin_it.ts \
                src/qt/locale/fertcoin_ja.ts \
                src/qt/locale/fertcoin_pl.ts \
                src/qt/locale/fertcoin_pt.ts \
                src/qt/locale/fertcoin_ru.ts \
                src/qt/locale/fertcoin_sk.ts \
                src/qt/locale/fertcoin_sv.ts \
                src/qt/locale/fertcoin_vi.ts \
                src/qt/locale/fertcoin_zh_CN.ts \
                src/qt/locale/fertcoin_zh_TW.ts
