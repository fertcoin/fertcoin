...
This means one can have an always-on fertcoind instance running, and another local fertcoind/fertcoin-qt instance which connects to this node and receives blocks from it.
