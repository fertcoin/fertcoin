...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop fertcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "fertcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* fertcoin features */
        {"fertcoin", "masternode", &masternode, true, true, false},
        {"fertcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"fertcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fertcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fertcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fertcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fertcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fertcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fertcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"fertcoin", "startmasternode", &startmasternode, true, true, false},
        {"fertcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fertcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fertcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fertcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fertcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fertcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fertcoin", "mnbudget", &mnbudget, true, true, false},
        {"fertcoin", "preparebudget", &preparebudget, true, true, false},
        {"fertcoin", "submitbudget", &submitbudget, true, true, false},
        {"fertcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fertcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fertcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fertcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fertcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fertcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fertcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fertcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"fertcoin", "mnsync", &mnsync, true, true, false},
        {"fertcoin", "spork", &spork, true, true, false},
        {"fertcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> fertcoin-cli " + methodname + " " + args + "\n";
}
