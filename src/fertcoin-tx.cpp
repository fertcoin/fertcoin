...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("fertcoin fertcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fertcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fertcoin transaction") + "\n" +
                               "  fertcoin-tx [options] -create [commands]   " + _("Create hex-encoded fertcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fertcoin transaction
