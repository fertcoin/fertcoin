...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 2 * 60; //120 minutes
        nTargetSpacing = 120; // 120 mins
        nMaturity = 10;
        ...
        const char* pszTimestamp = "fertcoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1625882850;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 12213851;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x668895b92252f8bd17dfc62bca893c0f508bb6c08ab73909d0638611fcaf7896"));
        assert(hashGenesisBlock == uint256("0x0000029a582bb4ce16f3e2c47ec09b1f56ba32981fe680aea5abce5b0b37c16d"));
		
	vSeeds.push_back(CDNSSeedData("45.32.229.179","45.32.229.179"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x668895b92252f8bd17dfc62bca893c0f508bb6c08ab73909d0638611fcaf7896"));
        assert(hashGenesisBlock == uint256("0x0000bf3e6ff66e77633b61a2553da25f3fd25b01660b0a0df0f61332378df994"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x668895b92252f8bd17dfc62bca893c0f508bb6c08ab73909d0638611fcaf7896"));
        assert(hashGenesisBlock == uint256("0x15c87b56b37f2321b3c1cd60f5374071459eaf4dfcb4bbd0d17f410191267a92"));
