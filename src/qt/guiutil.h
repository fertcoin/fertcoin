...
/** Utility functions used by the fertcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render fertcoin addresses in monospace font
...
// Parse "fertcoin:" URI into recipient object, return true on successful parsing
