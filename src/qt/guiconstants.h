...
/* fertcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "fertcoin"
#define QAPP_ORG_DOMAIN "fertcoinproject.org"
#define QAPP_APP_NAME_DEFAULT "fertcoin-Qt"
#define QAPP_APP_NAME_TESTNET "fertcoin-Qt-testnet"
