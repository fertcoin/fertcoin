...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("fertcoin Core"),
     ...
     * override -datadir in the fertcoin.conf file in the default data directory
     * (to be consistent with fertcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
