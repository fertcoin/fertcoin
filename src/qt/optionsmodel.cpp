...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::fertcoin);
    ...
    if (!settings.contains("nAnonymizefertcoinAmount"))
        settings.setValue("nAnonymizefertcoinAmount", 1000);

    nAnonymizefertcoinAmount = settings.value("nAnonymizefertcoinAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizefertcoinAmount"))
        SoftSetArg("-anonymizefertcoinamount", settings.value("nAnonymizefertcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in fertcoin.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizefertcoinAmount:
            return QVariant(nAnonymizefertcoinAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizefertcoinAmount:
            nAnonymizefertcoinAmount = value.toInt();
            settings.setValue("nAnonymizefertcoinAmount", nAnonymizefertcoinAmount);
            emit anonymizefertcoinAmountChanged(nAnonymizefertcoinAmount);
            break;
        case CoinControlFeatures:
