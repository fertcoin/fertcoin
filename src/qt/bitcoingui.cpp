                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("fertcoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&fertcoin Project"), this);
    webmainAction->setStatusTip(tr("fertcoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("fertcoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("fertcoin Twitter"));
    ...
    discordAction->setStatusTip(tr("fertcoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("fertcoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("fertcoin Telegram"));
    ...
    redditAction->setStatusTip(tr("fertcoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap fertcoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell fertcoin Coin (fertcoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    fertcoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&fertcoin block explorer"), this);
    fertcoinBlockExplorerAction->setStatusTip(tr("fertcoin blockchain explorer"));
    fertcoinBlockExplorerAction->setToolTip(fertcoinBlockExplorerAction->statusTip());
    fertcoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&fertcoin Project Github"), this);
    githubAction->setStatusTip(tr("fertcoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a fertcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fertcoin: URIs)"));
...
//    }
    ...
    connect(fertcoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(fertcoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About fertcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about fertcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for fertcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your fertcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified fertcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a fertcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the fertcoin Core help message to get a list with possible fertcoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(fertcoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("fertcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.fertcoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/fertcoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/fertcoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/fertcoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/fertcoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::fertcoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/fertcoin/fertcoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to fertcoin network", "", count));
}
...
{
    QString strTitle = tr("fertcoin Core"); // default title
