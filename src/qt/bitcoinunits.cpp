...
QString BitcoinUnits::id(int unit)
{
    ...
    case fertcoin:
        return QString("FERT");
    case mECA:
        return QString("mFERT");
    case uECA:
        return QString::fromUtf8("uFERT");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case fertcoin:
            return QString("tFERT");
        case mECA:
            return QString("mtFERT");
        case uECA:
            return QString::fromUtf8("FERT");
        default:
            return QString("???");
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case fertcoin:
            return QString("FERT");
        case mECA:
            return QString("Milli-FERT(1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-FERT(1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case fertcoin:
            return QString("TestFERT");
        case mECA:
            return QString("Milli-TestFERT (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestFERT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
